  ...
  return (
    <div className="space-y-6">
      ...
      {randomizerState.rawaccelGuiRunning && (
        <div className="p-4 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-300 text-xs flex items-center gap-3 shadow-sm">
          <svg
          ...
          <div className="flex-1 leading-relaxed">
            <span className="font-semibold block">{t("randomizer.rawaccelGuiRunning")}</span>
          </div>
        </div>
      )}
